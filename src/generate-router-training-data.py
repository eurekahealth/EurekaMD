...
if __name__ == '__main__':
    ...
    parser.add_argument("--gpt-cot-file-location", type=str, default="data/generated/gpt-4o_training_cots.csv", help="The location of the gpt generated chain of thoughts.")
    parser.add_argument("--llama-cot-file-location", type=str, default="data/generated/llama_training_cots.csv", help="The location of the llama generated chain of thoughts.")
    parser.add_argument("--similar_questions-file-location", type=str, default="data/generated/similar_training_questions_to_dev.csv", help="The location of the file mapping questions in the dev set to similar training questions.")
