...
if __name__ == '__main__':
    ...
    parser.add_argument("--similar-questions-file-location", type=str, default="data/generated/similar_training_questions.csv", help="The location of the file mapping training questions to similar test questions.")
